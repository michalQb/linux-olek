 ...
 * with the presence of `-ffunction-section` in KBUILD_CFLAGS.
 */
#if defined(CONFIG_ASM_FUNCTION_SECTIONS) &&				    \
    ((defined(CONFIG_LD_DEAD_CODE_DATA_ELIMINATION) && !defined(MODULE)) || \
     ...
     (defined(CONFIG_LTO_CLANG))) && !defined(__DISABLE_EXPORTS)
...
#else /* !(ASM_FUNCTION_SECTIONS && (DCE || FG_KASLR || LTO) && !__DISABLE_EXPORTS) */

#define SYM_PUSH_SECTION(name)
#define SYM_POP_SECTION()
#define __ASM_PUSH_SECTION(name)

#endif /* !(ASM_FUNCTION_SECTIONS && (DCE || FG_KASLR || LTO) && !__DISABLE_EXPORTS) */
...
/* SYM_OUTER_LABEL -- for labels outside of code */
#ifndef SYM_OUTER_LABEL
#define SYM_OUTER_LABEL(name)				\
	SYM_START(name, SYM_L_GLOBAL, SYM_A_NONE)
#endif

/* SYM_LABEL_END -- the end of SYM_{INNER,OUTER}_LABEL{,_ALIGN} */
#ifndef SYM_LABEL_END
#define SYM_LABEL_END(name)				\
 ...
 * will be conditionally placed into a section specified in the second
 * argument.
 */
...
#define SYM_FUNC_ALIAS(alias, name)					\
	SYM_PUSH_SECTION(name) ASM_NL					\
	SYM_ALIAS(alias, name, SYM_L_GLOBAL) ASM_NL			\
	SYM_POP_SECTION()
#endif
...
#define SYM_FUNC_ALIAS_LOCAL(alias, name)				\
	SYM_PUSH_SECTION(name) ASM_NL					\
	SYM_ALIAS(alias, name, SYM_L_LOCAL) ASM_NL			\
	SYM_POP_SECTION()
#endif
...
#define SYM_FUNC_ALIAS_WEAK(alias, name)				\
	SYM_PUSH_SECTION(name) ASM_NL					\
	SYM_ALIAS(alias, name, SYM_L_WEAK) ASM_NL			\
	SYM_POP_SECTION()
#endif
