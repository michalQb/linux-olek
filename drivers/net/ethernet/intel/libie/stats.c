...
LIBIE_EXPORT_SYMBOL(libie_rq_stats_get_sset_count);
...
LIBIE_EXPORT_SYMBOL(libie_rq_stats_get_strings);
...
LIBIE_EXPORT_SYMBOL(libie_rq_stats_get_data);
...
LIBIE_EXPORT_SYMBOL(libie_sq_stats_get_sset_count);
...
LIBIE_EXPORT_SYMBOL(libie_sq_stats_get_strings);
...
LIBIE_EXPORT_SYMBOL(libie_sq_stats_get_data);
