...
/**
 * idpf_init_queue_set - initialize all queues in set
 * @qs: set of the queues to initialize
 *
...
/**
 * idpf_clean_queue_set - clean all queues in set
 * @qs: set of the queues to clean
 */
 ...
 *
 * Return: false if HW GRO failed, true otherwise.
 */
static int
...
/**
 * idpf_q_vector_set_napi - link or unlink vector's NAPI to its queues
 * @q_vector: queue vector to process
 * @link: whether to link or unlink the queues
 */
